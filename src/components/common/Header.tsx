    ...
    return (
        <div className={`bg-light-black md:h-[100px] sm:h-16 h-[50px] flex items-center w-full transition-all duration-500 ${isScrolled ? "fixed top-0 left-0 w-full shadow-lg !bg-black !z-[100]" : "relative"
                ...
                <div className="container flex justify-between w-full mx-auto items-center relative">
                    <button onClick={() => setOpen(!open)} className={`hidden w-[39px] h-8 justify-between items-center max-xl:absolute max-xl:right-5 relative z-[70] max-xl:flex flex-col overflow-hidden ${open ?"pt-3":"pt-0"}`}>
