...
const Vision = () => {
  return (
    <div className="bg-dark-blue lg:pb-[65px] sm:pb-[70px] pb-8 sm:pt-[99px] pt-5 -mt-[2px]" id="vision">
              ...
              <div className="relative bg-gradient-to-b cursor-pointer from-deep-blue via-purple to-orange rounded-[10px] h-full p-[1px] group">
                <div className="bg-dark-gray rounded-[10px] px-7 max-sm:px-4 pt-[90px] pb-8 h-full hover:bg-transparent">
                  <Description
                    ...
                    styleClass={`!leading-[27.2px] mx-auto !text-center max-w-[282px] ${i===0?"lg:!max-w-[300px]": i===1?"lg:max-w-[264]": i===2?"lg:max-w-[278px]":""}`}
                  />
                </div>
